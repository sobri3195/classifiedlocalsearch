        ...
        <div id="content">
			...
			<form id="form" action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
						<input class="text-input" name="width" type="text" /> (Ex 300)
					       </div>
                    </div>
                    <div class="form-group">
                        <label for="text1" class="control-label col-lg-4">Height</label>
                        <div class="col-lg-8">
						<input class="text-input" name="height" type="text" /> (Ex 450)
					</div></div>
                    <div class="form-group">
