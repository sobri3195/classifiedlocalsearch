...
<div class="" id="wrap">
        ...
        <div id="content">
		    ...
		    <div class="block">
                ...
                <a href="<?=common::get_component_link(array('size','add')); ?>" class="btn btn-primary f_right " style="float: right;" >Add New</a>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                	...
                	<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                            ...
                            <? foreach($data as $val){ ?>
								<tr>
									...
									<td>
										<!-- Icons -->
										 <a href="<?=common::get_component_link(array('size','edit')).'&id='.$val['id']; ?>" title="Edit"><i class="fa fa-edit"></i></a>
										 <a href="<?=common::get_component_link(array('size','delete')).'&id='.$val['id']; ?>" title="Delete"><i class="glyphicon glyphicon-remove"></i></a> 
