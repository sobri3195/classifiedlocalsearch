...
<div class="row">
<div class="col-lg-12">
<h1 class="page-header"><i class="fa fa-plus-circle fa-fw"></i> Add Category</h1>
</div>
</div>
<div class="row">
    <div class="col-md-6">
...
<div class="panel panel-default">
			...
			<form id="form" action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="text1" class="control-label col-lg-4">Select Parent Category</label>
                        <div class="col-lg-8">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <? foreach($data as $d){ ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">
                                             <a href="<?=common::get_component_link(array('category','edit')).'&id='.$d['id']; ?>" class=""  title="Edit"  style="float: left; padding: 5px;" ><i class="glyphicon glyphicon-pencil"></i></a>
										 <a href="<?=common::get_component_link(array('category','delete')).'&id='.$d['id']; ?>" class="" style="float: left; padding: 5px;"  title="Delete"><i class="glyphicon glyphicon-remove"></i></a> 
